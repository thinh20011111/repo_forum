...
@section('title', 'Quản lý diễn đàn khoa CNTT - FITA VNUA || Quản lý báo cáo bài viết')
...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-7 align-self-center">
            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Quản lý báo cáo bài viết <span class="text-danger" >({{ $report_count }})</span></h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        <li class="breadcrumb-item"><a href="./admin" class="text-muted">Trang chủ</a></li>
                        <li class="breadcrumb-item text-muted active" aria-current="page">Quản lý báo cáo bài viết</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <table class="table no-wrap v-middle mb-0">
                            <thead>
                                <tr class="border-0">
                                    ...
                                    <th class="border-0 font-14 font-weight-medium text-muted">Bài viết đăng bởi
                                    </th>
