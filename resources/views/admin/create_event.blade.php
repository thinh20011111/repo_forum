...
@section('title', 'Quản lý diễn đàn khoa CNTT - FITA VNUA || Thêm sự kiện mới')
            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item text-muted active" aria-current="page">Thêm sự kiện mới</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="admin/manage_event/create_event" class="mt-4 activity" enctype="multipart/form-data">
                        @csrf
                        <div class="d-flex align-items-start justify-content-center -line pb-3">
                            <div>
                                <img id="img_event_preview" name="" src="front/img/default_img.png" alt="user" style="max-width: 300px; height: auto; margin: 0;">
                        ...
                        <div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="title" class="form-control" placeholder="Nhập tiêu đề sự kiện" value="{{ old('title') }}"/>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label font-weight-bold">Nội dung</label>
                                <div class="col-sm-9">
                                    <textarea class="" rows="2" placeholder="Nhập nội dung" id="content" name="content">{{ old('content') }}</textarea>
                                </div>
                            </div>
                        </div>
