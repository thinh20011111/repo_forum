...
@section('title', 'Diễn đàn khoa CNTT - FITA VNUA || Top bài viết')

@section('body')
<div class="col-lg-6">
    <div class="central-meta">
        <h4 class="font-weight-bold mb-2">Top bài viết</h4>
    ...
    <aside class="sidebar static">
        ...
        <div class="widget">
            ...
            <div class="m-3">
                ...
                <a href="./top_member/top_post" class="list-group-item list-group-item-action active">Top bài viết</a>
