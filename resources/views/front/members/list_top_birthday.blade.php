...
@section('title', 'Diễn đàn khoa CNTT - FITA VNUA || Sinh nhật hôm nay')

@section('body')
<div class="col-lg-6">
    <div class="central-meta">
        <h4 class="font-weight-bold mb-2">Sinh nhật hôm nay</h4>
        ...
        <li style="border: none;" class="list-group-item d-flex justify-content-between align-items-center">
            <div class="friend-info w-auto">
                <figure>
                    <img src="front/img/users/{{ $user->avatar ?? 'default_user.png' }}" alt="" style="min-width: 40px;min-height: 40px;max-width: 40px;max-height: 40px;object-fit: cover;" />
                </figure>
            </div>
            <div class="friend-name">
                <ins>
                    ...
                    @endif
                    @foreach($users as $user11)
                    @if($user11->id == $user->id)
                    <p class="font-weight-normal">Bài viết: {{ number_format($user11->posts->count()) }} . <span>Lượt thích: {{number_format($user11->likes->count())}}</span></p>
                    @endif
                    @endforeach
                </ins>
            </div>
...
<div class="col-lg-3">
    <aside class="sidebar static">
        ...
        <div class="widget">
            ...
            <br><br>
            <div class="m-3">
                <a href="./top_member" class="list-group-item list-group-item-action ">
                    Overview
                </a>
                ...
                <a href="./top_member/birthday_today" class="list-group-item list-group-item-action active">Sinh nhật hôm nay</a>
