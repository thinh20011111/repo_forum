...
@section('title', 'Diễn đàn khoa CNTT - FITA VNUA || Danh sách BQT')

@section('body')
<div class="col-lg-6">
    <div class="central-meta">
        <h4 class="font-weight-bold mb-2">Danh sách BQT</h4>
        ...
        <li style="border: none;" class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <div class="friend-name">
                <ins><a class="d-flex justify-content-start align-items-center" href="./user-profile-post-{{ $user->id }}" title="">
                    ...
                    <p>Bài viết: {{ number_format($user11->posts->count()) }} . <span>Lượt thích: {{number_format($user11->likes->count())}}</span></p>
                    @endif
                    @endforeach
                </ins>
            </div>
    ...
    <aside class="sidebar static">
        ...
        <div class="widget">
            ...
            <div class="m-3">
                ...
                <a href="./top_member/list_admin" class="list-group-item list-group-item-action active">Danh sách BQT</a>
            </div>
        </div>
