...
@section('title', 'Diễn đàn khoa CNTT - FITA VNUA || Top lượt thích')

@section('body')
<div class="col-lg-6">
    <div class="central-meta">
        <h4 class="font-weight-bold mb-2">Top lượt thích</h4>
    ...
    <aside class="sidebar static">
        ...
        <div class="widget">
            ...
            <div class="m-3">
                ...
                <a href="./top_member/top_like" class="list-group-item list-group-item-action active">Top lượt thích</a>
