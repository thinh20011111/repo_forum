...
@section('title', 'Diễn đàn khoa CNTT - FITA VNUA || Đang truy cập')
        ...
        <ul class="nearby-contct">
            ...
            <li>
                <div class="nearly-pepls">
                    <figure>
                        <a href="time-line.html" class="d-flex justify-content-center" title=""><img src="front/img/users/{{ $user->avatar ?? 'default_user.png' }}" alt="{{ $user->name }}" style="width: 35px;height: 35px;object-fit: cover;"></a>
                    </figure>
                    <div class="pepl-info">
                        <h4>
                            @if($user->level == 0)
                        ...
                        <em><i class='fas fa-book-open'></i>
                            {{ $user->getPostCount($user->id) }} Bài viết</em>
                        @if(Auth::check())
                        @php
