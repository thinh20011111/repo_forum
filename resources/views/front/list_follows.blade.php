...
@section('title', 'Diễn đàn khoa CNTT - FITA VNUA || Danh sách theo dõi')
...
<div class="col-lg-6">
    <div class="central-meta">
        ...
        <ul class="nearby-contct">
            @if($list_follows->count() > 0)
            @foreach($list_follows as $user)
            @if(Auth::check())
            @if($user->id != Auth::user()->id)
            <li>
                <div class="nearly-pepls">
                    <figure>
                        <a href="/user-profile-post-{{ $user->id }}" class="d-flex justify-content-center" title="">
